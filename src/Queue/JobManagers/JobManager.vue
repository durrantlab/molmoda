<template>
    <div>
        ...
        >
            <div
                v-if="
                    jobStatusesForTable[idx] &&
                    jobStatusesForTable[idx].rows.length > 0
                "
            >
                <Table
          ...
          moo
            ...
            <div v-else>
                ...
                <p style="font-size: 14px">
                    You have not yet submitted any jobs
                </p>
            </div>
        </span>
    </div>
...
const headers: IHeader[] = [
    {
        ...
        showColumnFunc: (tableData: ITableData): boolean => {
            ...
            return (
                statuses.has(JobStatus.Pending) ||
                statuses.has(JobStatus.Running)
            );
        },
    },
                ...
                return {
                    "": {
                        ...
                        iconShowFilterFunc: (row: {
                            ...
                            return (
                                [JobStatus.Pending, JobStatus.Running].indexOf(
                                    status
                                ) >= 0
                            );
                        },
