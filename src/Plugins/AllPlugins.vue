...
<template>
  <div>
    ...
    <AddCustomStylePlugin @onPluginSetup="onPluginSetup"></AddCustomStylePlugin>
...
import AddCustomStylePlugin from "./Core/AddCustomStylePlugin.vue";
