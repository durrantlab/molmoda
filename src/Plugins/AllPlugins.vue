...
@Component({
 ...
 // TEMPLATE3 START
    ...
    ProtonateCompoundsPlugin: defineAsyncComponent(() => import("@/Plugins/Optional/CompoundProcessing/ProtonateCompounds/ProtonateCompoundsPlugin.vue")),
    ...
    Regen3DCoordsPlugin: defineAsyncComponent(() => import("@/Plugins/Optional/CompoundProcessing/Regen3DCoords/Regen3DCoordsPlugin.vue")),
