...
export default class TemporarySharePlugin extends PluginParentClass {
    ...
    details =
        "This plugin will upload your session to a remote server and generate a unique, temporary link that you can use to open the session on another device. The link will expire after a short period.";
    tags = [Tag.All];
