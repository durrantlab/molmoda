...
export class JobMsgs {
     ...
     */
    public onSubmitJobLogMsg(pluginId: string): string {
     ...
     * @returns {string}  The message to log.
     */
    public onStartJobLogMsg(pluginId: string): string {
     ...
     * @returns {string}  The message to log.
     */
    public onEndJobLogMsg(pluginId: string): string {
