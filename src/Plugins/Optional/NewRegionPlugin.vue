<template>
    <PluginComponent v-model="open" :infoPayload="infoPayload" @onPopupDone="onPopupDone" actionBtnTxt="New Region"
...
export default class NewRegionPlugin extends PluginParentClass {
    menuPath = "Regions/New Region...";
    title = "New Region";
