 ...
 *
 * @param {string} [message] - Optional message to indicate why the test is failing
...
function createFailingTest(message = "TODO: Implement this test"): ITest {
    return {
        /** 
         * Returns a command list that will always fail by waiting for a
        ...
        /**
         * Returns a command list that fails by waiting for a non-existent
         * element.
         *
         * @returns {TestCmdList} A command list that fails
         */
